---
title: "Conestoga College 조사"
slug: "conestoga-college"
type: "school"
status: "published"
visibility: "private"
format: "md"
summary: "Conestoga College의 학교 기본 정보, 주요 프로그램, 입학 요건, 학비, PGWP 가능 학과 목록까지 한 번에 확인할 수 있게 정리한 협업 완료본."
one_liner: "실무형·취업형 강점이 뚜렷한 온타리오 공립 컬리지로, 지금은 프로그램 선택과 PGWP 정합성이 특히 중요한 학교."
...
sources:
  - title: "Conestoga College Overview"
    ...
    collected_at: "2026-04-05"
  - title: "Campuses and Locations"
    url: "https://www.conestogac.on.ca/about/campuses-and-locations"
    collected_at: "2026-04-05"
  ...
  - title: "Fees & Payment"
    ...
    collected_at: "2026-04-05"
  - title: "Work Eligibility / PGWP FAQ"
...
# Conestoga College 조사

## 한눈에 보기
Conestoga College Institute of Technology and Advanced Learning은 온타리오주의 대표적인 공립 컬리지다.  
1967년에 설립됐고, 전통적인 연구중심 대학보다는 **실무형·취업형·폴리테크닉 성격**이 강하다.

주 생활권은 **Waterloo Region**이며, Kitchener, Waterloo, Cambridge를 중심으로 여러 캠퍼스를 운영한다.

### 한 줄 평가
**Conestoga는 이름값보다 실무교육, co-op, 지역 산업 연결성으로 평가받는 대형 공립 컬리지다.**

---

## 학교 기본 정보
- **공식 홈페이지:** https://www.conestogac.on.ca/
- **전체 Full-time 학과 목록:** https://www.conestogac.on.ca/fulltime
...
## 입학 요건
### Diploma / Certificate
- IELTS Academic 6.0 (each 5.5 이상)
- TOEFL iBT 80
- Duolingo 110
- PTE Academic 53

### Degree / Graduate Certificate
- IELTS Academic 6.5 (each 6.0 이상)
- TOEFL iBT 88
- Duolingo 120
- PTE Academic 58

> 일부 IT / Engineering 프로그램은 더 높은 영어 기준을 요구할 수 있다.

### 영어 미충족 시
직접 입학 기준에 못 미치면  
**General Arts and Science: English Language Studies** 경로를 검토할 수 있다.

---

## 학비 / 예치금
### 예치금
- 국제학생은 **CAD 2,500 필수 예치금**이 필요
- 일반적으로 **합격 후 30일 이내 납부**
- 비자 거절 증빙 제출 시 환불 규정 적용
- 기한 후 납부 시 추가 charge 가능

### 학비 해석
Conestoga는 프로그램별 차이가 크기 때문에, 실제 상담에서는 **프로그램 페이지 또는 오퍼레터 기준 재확인**이 필요하다.

상담용으로는 보통 이렇게 설명하면 안전하다:
- diploma 계열: 대체로 국제학생 기준 연 **CAD 15,000대 tuition**
- degree 계열: 대체로 국제학생 기준 연 **CAD 16,000대 tuition**
- ancillary fees, 보험, 생활비, 교재비는 별도

---

## Co-op / 현장실습
Conestoga는 **85개 이상 co-op 프로그램**을 운영한다고 안내한다.

### 상담 포인트
- co-op가 있다고 자동 취업이 보장되지는 않음
- 하지만 현지 경력, 이력서 현지화, 네트워킹, 졸업 후 취업 연결에는 분명 장점이 있음
- 특히 IT, 공학, 비즈니스, 공급망, 실무기술 분야 학생에게 설득력이 큼

---

## PGWP / 비자 관련 핵심
여기가 현재 가장 중요한 체크 포인트다.

### 핵심 정리
- **Conestoga 졸업 = 자동 PGWP 보장 아님**
- **2024-11-01 이후** study permit 신청자는 새 PGWP 기준 영향을 받음
- 학교는 **PGWP-aligned program 리스트 확인**을 계속 권장함
- **2025-03-11부터 bachelor’s degree는 field of study requirement 예외**
- 최종 판단은 언제나 **IRCC**

### 실무 해석
- bachelor’s degree 프로그램은 상대적으로 설명이 쉬움
- diploma / advanced diploma / graduate certificate는  
  **프로그램별 PGWP-aligned 여부를 반드시 다시 확인해야 함**

### 상담용 한 줄
**지금은 학교 이름보다 프로그램의 PGWP 정합성이 더 중요하다.**
...
- **인공지능 및 기계 학습 응용 (코업 옵션) / Applied Artificial Intelligence & Machine Learning (Optional Co-op)**  
  ...
  - CIP: 11.0102  
  - Code: 1557  
  - Link: https://www.conestogac.on.ca/fulltime/applied-artificial-intelligence-machine-learning
- **건축 - 건설 엔지니어링 기술 (코업 옵션) / Architecture - Construction Engineering Technology (Optional Co-op)**  
  - Credential: Ontario College Advanced Diploma  
  - Start: September  
  - CIP: 15.1001  
  - Code: 0025  
  - Link: https://www.conestogac.on.ca/fulltime/architecture-construction-engineering-technology
- **생명 공학 기술자 / Biotechnology Technician**  
...
- **토목공학 테크놀로지 (코업 옵션) / Civil Engineering Technology (Optional Co-op)**  
  ...
  - CIP: 15.0201  
  - Code: 0024  
  - Link: https://www.conestogac.on.ca/fulltime/civil-engineering-technology
- **컴퓨터 애플리케이션 개발 (코업 옵션) / Computer Applications Development (Optional Co-op)**  
  - Credential: Ontario College Graduate Certificate  
  - Start: September, January, May  
  - CIP: 11.0201  
  - Code: 0066  
  - Link: https://www.conestogac.on.ca/fulltime/computer-applications-development
- **컴퓨터 공학 기술 (코업 옵션) / Computer Engineering Technology (Optional Co-op)**  
  - Credential: Ontario College Advanced Diploma  
  - Start: September  
  - CIP: 15.1201  
  - Code: 1060  
  - Link: https://www.conestogac.on.ca/fulltime/computer-engineering-technology
- **컴퓨터 프로그래밍 / Computer Programming**  
  - Credential: Ontario College Diploma  
  - Start: September, January, May  
  - CIP: 11.0201  
  - Code: 1009  
  - Link: https://www.conestogac.on.ca/fulltime/computer-programming
- **컴퓨터 프로그래밍 - 데이터 관리 / Computer Programming - Data Management**  
  - Credential: Ontario College Diploma  
  - Start: September, January  
  - CIP: 11.0201  
  - Code: 1645  
  - Link: https://www.conestogac.on.ca/fulltime/computer-programming-data-management
- **컴퓨터 프로그래밍 및 분석 (코업 옵션) / Computer Programming and Analysis (Optional Co-op)**  
  - Credential: Ontario College Advanced Diploma  
  - Start: September, January, May  
  - CIP: 11.0201  
  - Code: 0057  
  - Link: https://www.conestogac.on.ca/fulltime/computer-programming-and-analysis
- **컴퓨터 시스템 기술자 - 정보 기술 인프라 및 서비스 (코업 옵션) / Computer Systems Technician - Information Technology Infrastructure and Services (Optional Co-op)**  
  - Credential: Ontario College Diploma  
  - Start: September, January  
  - CIP: 15.1202  
  - Code: 1097  
  - Link: https://www.conestogac.on.ca/fulltime/computer-systems-technician-information-technology-infrastructure-and-services
- **사이버 보안 대응 계획 (코업 옵션) / Cybersecurity Response Planning (Optional Co-op)**  
  - Credential: Ontario College Graduate Certificate  
  - Start: September, January, May  
  - CIP: 11.1003  
  - Code: 1580  
  - Link: https://www.conestogac.on.ca/fulltime/cybersecurity-response-planning
- **데이터 처리 및 보고 / Data Processing and Reporting**  
...
- **전자공학 테크놀로지 (코업 옵션) / Electronics Engineering Technology (Optional Co-op)**  
  ...
  - CIP: 15.0303  
  - Code: 0098  
  - Link: https://www.conestogac.on.ca/fulltime/electronics-engineering-technology
- **에너지 시스템 엔지니어링 기술 - 전기 (코업 옵션) / Energy Systems Engineering Technology - Electrical (Optional Co-op)**  
  - Credential: Ontario College Advanced Diploma  
  - Start: September  
  - CIP: 15.0501  
  - Code: 0029  
...
- **환경공학 응용 (코업 옵션) / Environmental Engineering Applications (Optional Co-op)**  
  ...
  - CIP: 15.0507  
  - Code: 0870  
  - Link: https://www.conestogac.on.ca/fulltime/environmental-engineering-applications
- **난방, 냉장 및 에어컨 기술자 / Heating, Refrigeration and Air Conditioning Technician**  
  - Credential: Ontario College Diploma  
  - Start: September, January  
  - CIP: 15.0501  
  - Code: 0465  
...
- **고급 CNC 제조 / Advanced CNC Manufacturing**  
  ...
  - CIP: 48.0510  
  - Code: 1581  
  - Link: https://www.conestogac.on.ca/fulltime/advanced-cnc-manufacturing
- **목공 및 리노베이션 기술자 (코업 옵션) / Carpentry and Renovation Technician (Optional Co-op)**  
  - Credential: Ontario College Diploma  
  - Start: September  
  - CIP: 46.0201  
  - Code: 1142  
  - Link: https://www.conestogac.on.ca/fulltime/carpentry-and-renovation-technician
- **건설 기술 (목공) / Construction Techniques (Carpentry)**  
  - Credential: Ontario College Certificate  
  - Start: September  
  - CIP: 46.0000  
  - Code: 07165  
  - Link: https://www.conestogac.on.ca/fulltime/construction-techniques-carpentry
- **건설 기술 (목공, 전기, HVAC 및 용접) / Construction Techniques (Carpentry, Electrical, HVAC and Welding)**  
  - Credential: Ontario College Certificate  
  - Start: September  
  - CIP: 46.0000  
  - Code: 07161  
  - Link: https://www.conestogac.on.ca/fulltime/construction-techniques-carpentry-electrical-hvac-and-welding
- **건설 기술 (벽돌, 배관, 전기, 목공) / Construction Techniques (Masonry, Plumbing, Electrical, and Carpentry)**  
  - Credential: Ontario College Certificate  
  - Start: May  
  - CIP: 46.0000  
  - Code: 07164  
  - Link: https://www.conestogac.on.ca/fulltime/construction-techniques-masonry-plumbing-electrical-and-carpentry
- **건설 기술 (용접, HVAC, 배관 및 벽돌) / Construction Techniques (Welding, HVAC, Plumbing, and Masonry)**  
  - Credential: Ontario College Certificate  
  - Start: January  
  - CIP: 46.0000  
  - Code: 07163  
  - Link: https://www.conestogac.on.ca/fulltime/construction-techniques-welding-hvac-plumbing-and-masonry
- **건설 기술 - 벽돌 및 석재 / Construction Techniques - Brick and Stone**  
  - Credential: Ontario College Certificate  
  - Start: September  
  - CIP: 46.0101  
  - Code: 1497  
  - Link: https://www.conestogac.on.ca/fulltime/construction-techniques-brick-and-stone
- **전기 기술 / Electrical Techniques**  
  - Credential: Ontario College Certificate  
  - Start: September, January, May  
  - CIP: 46.0302  
  - Code: 1327  
...
- **유아교육 패스트트랙 (ECE) / Early Childhood Education Fast Track (ECE)**  
  ...
  - Code: 00031  
  - Link: https://www.conestogac.on.ca/fulltime/early-childhood-education-fast-track-ece
- **금융 기술 / Financial Technology**  
  - Credential: Ontario College Graduate Certificate  
  - Start: September, January, May  
  - CIP: 30.7104  
  - Code: 1519  
  - Link: https://www.conestogac.on.ca/fulltime/financial-technology
- **그래픽 디자인 / Graphic Design**  
  - Credential: Ontario College Advanced Diploma  
  - Start: September, January  
  - CIP: 50.0409  
  - Code: 0049  
  - Link: https://www.conestogac.on.ca/fulltime/graphic-design
- **휴먼 서비스 기초 / Human Services Foundation**  
  - Credential: Ontario College Certificate  
  - Start: September, January, May  
  - CIP: 44.0000  
  - Code: 1053  
...
- **도시계획 및 GIS / Urban Planning and GIS**  
  ...
  - CIP: 04.0301  
  - Code: 1585  
  - Link: https://www.conestogac.on.ca/fulltime/urban-planning-and-gis

### 농업·식품 / Agriculture and agri-food (3)
- **농업 비즈니스 관리 / Agri-Business Management**  
  - Credential: Ontario College Graduate Certificate  
  - Start: September, January, May  
  - CIP: 01.0101  
  - Code: 1588  
...
- **아동 정신 건강 서비스 / Children's Mental Health Services**  
  ...
  - CIP: 51.1510  
  - Code: 1617  
  - Link: https://www.conestogac.on.ca/fulltime/childrens-mental-health-services
- **커뮤니티 약국 보조 / Community Pharmacy Assistant**  
  - Credential: Ontario College Certificate  
  - Start: September, January, May  
  - CIP: 51.0805  
  - Code: 1499  
...
- **헬스케어 프로젝트 리더십 및 관리 / Healthcare Project Leadership and Management**  
  ...
  - CIP: 51.0704  
  - Code: 1638  
  - Link: https://www.conestogac.on.ca/fulltime/healthcare-project-leadership-and-management
- **보청기 전문가 / Hearing Instrument Specialist**  
  - Credential: Ontario College Diploma  
  - Start: September  
  - CIP: 51.0918  
  - Code: 1176  
...
- **비즈니스 - 보험 (코업 옵션) / Business - Insurance (Optional Co-op)**  
  ...
  - CIP: 52.1701  
  - Code: 0722  
  - Link: https://www.conestogac.on.ca/fulltime/business-insurance
- **비즈니스 - 상업용 트럭 운송을 위한 공급망 및 운영 관리 / Business - Supply Chain and Operations for Commercial Trucking**  
  - Credential: Ontario College Diploma  
  - Start: September, January, May  
  - CIP: 52.0209  
  - Code: 1540  
...
- **글로벌 공급망 관리 / Supply Chain Management - Global**  
  ...
  - CIP: 52.0203  
  - Code: 1411  
  - Link: https://www.conestogac.on.ca/fulltime/supply-chain-management-global
- **전자 상거래 관리 / eCommerce Management**  
  - Credential: Ontario College Graduate Certificate  
  - Start: September, May  
  - CIP: 52.0208  
  - Code: 1604  
...
- **애니메이션 학사 / Bachelor of Animation**  
  ...
  - CIP: 10.0304  
  - Code: 1671C  
  - Link: https://www.conestogac.on.ca/fulltime/bachelor-of-animation
- **생명공학 응용 학사 (우등 학사) / Bachelor of Applied Biotechnology (Honours)**  
  - Credential: Degree  
  - Start: September  
  - CIP: 26.1201  
  - Code: 1560C  
...
- **응용기술 학사 (우등 학사) - 건축 프로젝트 및 시설 관리 / Bachelor of Applied Technology (Honours) - Architecture - Project and Facility Management**  
  ...
  - CIP: 15.0101  
  - Code: 1099C  
  - Link: https://www.conestogac.on.ca/fulltime/bachelor-of-applied-technology-honours-architecture-project-and-facility-management
- **경영학 학사 (우등 학사) - 회계, 감사 및 정보 기술 / Bachelor of Business Administration (Honours) - Accounting, Audit and Information Technology**  
  - Credential: Degree  
  - Start: September, January  
  - CIP: 30.1601  
  - Code: 1241C  
...
- **지역사회 및 형사사법 학사 (우등 학사) / Bachelor of Community and Criminal Justice (Honours)**  
  ...
  - Code: 1240C  
  - Link: https://www.conestogac.on.ca/fulltime/bachelor-of-community-and-criminal-justice-honours
- **컴퓨터 사이언스 학사 / Bachelor of Computer Science**  
  - Credential: Degree  
  - Start: September, January  
  - CIP: 11.0701  
  - Code: 1635C  
  - Link: https://www.conestogac.on.ca/fulltime/bachelor-of-computer-science
- **컴퓨터 사이언스 학사 (우등 학사) / Bachelor of Computer Science (Honours)**  
  - Credential: Degree  
  - Start: September, January  
  - CIP: 11.0701  
  - Code: 1514C  
  - Link: https://www.conestogac.on.ca/fulltime/bachelor-of-computer-science-honours
- **데이터 분석 학사 / Bachelor of Data Analytics**  
  - Credential: Degree  
  - Start: September  
  - CIP: 30.7101  
  - Code: 1664C  
...
- **데이터사이언스 및 인공지능 학사 (우등 학사) / Bachelor of Data Science and Artificial Intelligence (Honours)**  
  ...
  - CIP: 11.0101  
  - Code: 1682C  
  - Link: https://www.conestogac.on.ca/fulltime/bachelor-of-data-science-and-artificial-intelligence-honours
- **디자인 학사 (우등 학사) / Bachelor of Design (Honours)**  
  - Credential: Degree  
  - Start: September  
  - CIP: 50.0409  
  - Code: 1336C  
...
- **유아교육 프로그램 개발 학사 (우등 학사) / Bachelor of Early Learning Program Development (Honours)**  
  ...
  - Code: 1355C  
  - Link: https://www.conestogac.on.ca/fulltime/bachelor-of-early-learning-program-development-honours
- **공학 학사 - 건축 시스템 공학 / Bachelor of Engineering - Building Systems Engineering**  
  - Credential: Degree  
  - Start: August  
  - CIP: 14.1401  
  - Code: 1425C  
  - Link: https://www.conestogac.on.ca/fulltime/bachelor-of-engineering-building-systems-engineering
- **공학 학사 - 전자 시스템 공학 / Bachelor of Engineering - Electronic Systems Engineering**  
  - Credential: Degree  
  - Start: August  
  - CIP: 14.1099  
  - Code: 1094C  
  - Link: https://www.conestogac.on.ca/fulltime/bachelor-of-engineering-electronic-systems-engineering
- **공학 학사 - 기계 시스템 공학 / Bachelor of Engineering - Mechanical Systems Engineering**  
  - Credential: Degree  
  - Start: August  
  - CIP: 14.1901  
  - Code: 1066C  
  - Link: https://www.conestogac.on.ca/fulltime/bachelor-of-engineering-mechanical-systems-engineering
- **공학 학사 - 전력 시스템 공학 / Bachelor of Engineering - Power Systems Engineering**  
  - Credential: Degree  
  - Start: August  
  - CIP: 14.1001  
  - Code: 1458C  
  - Link: https://www.conestogac.on.ca/fulltime/bachelor-of-engineering-power-systems-engineering
- **공학 학사 - 지속 가능한 디자인 공학 / Bachelor of Engineering - Sustainable Design Engineering**  
  - Credential: Degree  
  - Start: August  
  - CIP: 14.4801  
  - Code: 1626C  
  - Link: https://www.conestogac.on.ca/fulltime/bachelor-of-engineering-sustainable-design-engineering
- **환경 공중 보건 학사 (우등 학사) / Bachelor of Environmental Public Health (Honours)**  
  - Credential: Degree  
  - Start: September  
  - CIP: 51.2202  
  - Code: 1386C  
...
- **위험·위협·범죄분석 학사 (우등 학사) / Bachelor of Risk, Threat, and Crime Analysis (Honours)**  
  ...
  - CIP: 43.0403  
  - Code: 1657C  
  - Link: https://www.conestogac.on.ca/fulltime/bachelor-of-risk-threat-and-crime-analysis-honours

---

## 전체 학과 목록 확인 링크
전체 학과를 이 문서에 다 넣는 대신, 아래 **공식 인덱스 링크**에서 확인하면 돼.

- **Conestoga Full-time Programs 전체 목록:** https://www.conestogac.on.ca/fulltime

---

## 장점
1. 실무형·취업형 교육이 강함  
2. co-op / 현장실습 기회가 풍부함  
3. Waterloo Region 기반으로 현실적인 취업 설명이 가능함  
4. IT, 공학, 비즈니스, 공급망, 기술직까지 선택지가 넓음  
5. degree와 college 실무교육을 함께 설명할 수 있음

---

## 유의할 점
1. 최근 몇 년간 국제학생 과밀 이미지가 있었음  
2. 학교 전체보다 **프로그램별 편차**가 큼  
3. PGWP / 이민을 단순 루트로 보면 위험함  
4. 전통적인 연구중심 대학 캠퍼스 경험과는 결이 다를 수 있음
...
### 잘 맞는 학생
- 실무형 / 취업형 교육을 원하는 학생
- IT / Engineering / Business / Supply Chain / Trades 방향이 분명한 학생
- co-op과 현장경험을 중요하게 보는 학생
- Toronto prestige보다 현실적인 취업성과 지역 적합성을 중시하는 학생

### 더 신중해야 하는 학생
- 학교 prestige를 최우선으로 보는 학생
- 연구중심 university 경험을 원하는 학생
- PGWP를 단순하게 기대하는 학생
- 전공 목표 없이 입학 자체만 목표인 학생

---

## 최종 결론
**Conestoga는 잘 고른 전공이라면 충분히 강한 실무형 선택지가 될 수 있다.**  
다만 지금은 학교 브랜드보다도  
**전공 선택, PGWP 정합성, 지역 취업성**을 함께 봐야 하는 학교다.
...
- https://www.conestogac.on.ca/about/overview
- https://www.conestogac.on.ca/about/campuses-and-locations
- https://www.conestogac.on.ca/fulltime
- https://www.conestogac.on.ca/international/apply-to-conestoga/admission-requirements
- https://www.conestogac.on.ca/international/apply-to-conestoga/fees-and-payment
- https://www.conestogac.on.ca/international/immigration-information/work-eligibility
- https://www.conestogac.on.ca/international/apply-to-conestoga/pgwp-aligned-programs
